...
export default function PrayersAdmin() {
  ...
  return (
    <div className="w-full max-w-3xl mx-auto mt-8 px-2 md:px-8">
      <h1 className="text-2xl font-bold mb-6">Prayers</h1>
      {loading && <div>Loading...</div>}
      {error && <div className="text-red-600">{error}</div>}
      {cards.length === 0 && !loading && <div>No prayers found.</div>}
